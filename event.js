...
let swiper_box = document.querySelector(".mySwiper");
 ...
 const arr = [
  {
    id: 1,
    photo: "./img/Azamat.jpg",
    name: "Azamat",
    famil: "Uzakov",
    direction: "Главный веб разработчик",
  },
  {
    id: 2,
...
function ourTeam(arr) {
  ...
  for (let i of arr) {
    ...
    participant_box_img.style.height = "400px";
    participant_box_img.style.objectFit = "cover";
